<template>
  <div class="left-list" >
      <ul>
          <li v-for='i in controlList' @click="showCList(i)">
...
export default {
  ...
  data () {
    return {
      controlList:[
        {id:1,name:'后台首页','isOpen':false,url:'http://www.baidu.com'},
        {id:2,name:'我的面板','isOpen':false,children:[{id:21,name:'个人信息','isOpen':false,url:'http://www.baidu.com'},{id:22,name:'修改密码','isOpen':false,url:'http://www.baidu.com'},{id:23,name:'日志信息','isOpen':false,url:'http://www.baidu.com'}]},
        {id:3,name:'用户管理','isOpen':false,children:[{id:31,name:'用户列表','isOpen':false,url:'http://www.baidu.com'},{id:32,name:'角色列表','isOpen':false,url:'http://www.baidu.com'},{id:33,name:'菜单管理','isOpen':false,url:'http://www.baidu.com'}]},
        {id:4,name:'内容管理','isOpen':false,children:[{id:41,name:'网站栏目管理','isopen':false,url:'http://www.baidu.com'},{id:42,name:'所有档案列表','isOpen':false,url:'http://www.baidu.com'},{id:43,name:'待审核档案','isOpen':false,url:'http://www.baidu.com'},{id:44,name:'我发布的档案','isOpen':false,url:'http://www.baidu.com'},{id:45,name:'我发布的文档','isOpen':false,url:'http://www.baidu.com'}]}
      ]
    }
  },
  methods:{
